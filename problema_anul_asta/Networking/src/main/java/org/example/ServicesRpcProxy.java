...
public class ServicesRpcProxy implements IServices {
    ...
    @Override
    public Configuration getConfById(Integer data) throws ServicesException {
        Request request = new Request.Builder().type(RequestType.GET_CONF_BY_ID).data(data).build();
        sendRequest(request);
        Response response = readResponse();
